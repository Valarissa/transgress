...
The regular expressions to do replacement/content checking need to be created to cover a broader set of terms. Additionally,
there needs to be significant work in order to streamline the code so adding those regular expressions is as easy as possible.
